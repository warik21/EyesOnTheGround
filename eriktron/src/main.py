...
out = cv2.VideoWriter('C:/Users/eriki/OneDrive/Documents/all_folder/other_projects/eriktron/eriktron/src/camera_movement_still.mp4', fourcc, 
                      3.0, (result_size, int(result_size * result_ratio)))
